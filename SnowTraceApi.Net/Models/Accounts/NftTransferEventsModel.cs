...
{
    public class NftTransferEventsModel : SnowTraceBaseModel, ISnowTraceModel
    {
        ...
        public List<NftTransferEventsData>? NftTransferEventsData { get; set; }
    }

    public partial class NftTransferEventsData
    {
